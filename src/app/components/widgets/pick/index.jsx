...
const Pick = ({ setTitle, hasMadePick, onChangePick }) => {
    ...
    if (weekData) {
      setTitle(
        <div className="flex flex-col w-fit">
          ...
          <div className="text-gray-400 italic text-sm mb-[-2px] text-left
          ">
  ...
  if (!isLoading && pick && hasMadePick && weekData) {
